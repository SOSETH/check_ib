...
#define TIMEOUT 100
    ...
    uint64_t IBPort::operator[](const IBPort::PortAttribute attr) noexcept {
        return values[attr];
    }

    uint32_t getUIntField(MAD_FIELDS fieldA, MAD_FIELDS, uint8_t *bufA, uint8_t *) noexcept {
        uint32_t value;
...
#define INSERT_ELEMENT(p) strings[p] = #p
    ...
    std::ostream &operator<<(std::ostream &stream, const IBPort::PHYSPortState value) noexcept {
    ...
    std::ostream &operator<<(std::ostream &stream, const IBPort::LogPortState value) noexcept {
    ...
    std::ostream &operator<<(std::ostream &stream, const IBPort::LinkWidth value) noexcept {
    ...
    std::ostream &operator<<(std::ostream &stream, const IBPort::LinkSpeed value) noexcept {
    ...
    std::ostream &operator<<(std::ostream &stream, const IBPort::PortAttribute value) noexcept {
